...
$required = array('name', 'bID', 'email', 'start_day', 'start_hour');
  ...
  <main aria-label="main content" class="span8" id="main-body">
      ...
      <form id="msform" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" method="post">
        ...
        <input type="text" required = "" name="name" placeholder="Name" />
          <input type="text"required = "" name="bID" placeholder="Bronco ID" />
          ...
          <button onclick="return confirm('Please make sure that Bronco ID, email, time and day are correct')" type="submit" class="next action-button" name="book" />Schedule</button>
...
<main aria-label="main content" class="span4" id="main-body">
  ...
  <img src="img/ssc.png" alt="ssc" style="width:300px;height:350px;">
    ...
    <div class="row">
      ...
      <div class="span2">
        <div class="footer-nav">
          ...
          <p><a href="/noncppReservationSytem">Incoming Students Reservation</a></p>
